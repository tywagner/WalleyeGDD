...
for(i in 1:length(mean.beta)) { 
  u.alpha[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.95) )
  l.alpha[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.05) )
}
########
...
for(i in 1:length(mean.beta)) { 
  u.alphaa[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.95) )
  l.alphaa[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.05) )
}
########
...
for(i in 1:length(mean.beta)) { 
  u.alphaab[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.95) )
  l.alphaab[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.05) )
}
########
...
for(i in 1:length(mean.beta)) { 
  u.alphaabc[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.95) )
  l.alphaabc[i] <- quantile(out$BUGSoutput$sims.list$BB[,i,1],probs=c(0.05) )
}
########
